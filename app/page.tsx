...
export default function QuinceaneraInvitation() {
  ...
  const scenesWithCustomTiming = [0, 1, 2, 3, 4, 5, 6, 7, 8] // TitleScene, MessageScene1, MessageScene2, NameScene, MessageScene3, ParentsScene, ReceptionScene, GalleryScene, ScheduleScene
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      {currentScene === 3 && <MessageScene3 onComplete={handleSceneComplete} isActive={!isPaused} />}
